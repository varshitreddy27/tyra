...
<asp:UpdatePanel ID="RulesUpdatePanel" runat="server">
    <ContentTemplate>
        <table>
            <tr>
                <td>
                    <asp:Label ID="LibraryRulesErrorLabel" runat="server" Visible="false" CssClass="b24-errortext"></asp:Label>
                </td>
            </tr>
        </table>
                ...
                <asp:Panel ID="SubInfoPanel" runat="server" CssClass="b24-report-frame">
                    <table class="b24-subscription" border="0" cellpadding="2" cellspacing="2">
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="AccountCodeLabel" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="StartsLabel" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Label ID="SeatsLabel" runat="server" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            </td>
                            <td class="b24-report-link-label">
                                <asp:HyperLink ID="AccountInfoHyperLink" runat="server"><IMG align=absmiddle SRC="images/Go.gif" width=22 height=15 /></asp:HyperLink>AccountInfo
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td class="b24-report-link-label">
                                <asp:HyperLink ID="ManageAccountHyperLink" runat="server"><IMG align=absmiddle SRC="images/Go.gif" width=22 height=15 /></asp:HyperLink>ManageAccount
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td class="b24-report-link-label">
                                <asp:HyperLink ID="AdvancedReportHyperLink" runat="server"><IMG align=absmiddle SRC="images/Go.gif" width=22 height=15 /></asp:HyperLink>Reports
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                ...
                <asp:Panel ID="RulesPanel" runat="server" CssClass="b24-report-frame">
                    <asp:GridView ID="RulesGridView" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="b24-report-title"
                        ...
                        <Columns>
                            <asp:TemplateField ItemStyle-Wrap="false">
                                <ItemTemplate>
                                    ...
                                    <asp:ImageButton ID="DeleteButton" CommandArgument='<%# Eval("RuleID") %>' CommandName="Delete"
                                        runat="server" ImageUrl="~/images/GVDeleteButton.gif" AlternateText="Delete"
                                        Visible="false" OnClientClick="javascript:return confirm('Delete this record?  Are you sure?');" />
                                    <asp:ImageButton ID="UpdateButton" CommandArgument='<%# Eval("RuleID") %>' CommandName="Update"
                                        runat="server" ImageUrl="~/images/GVUpdateButton.gif" AlternateText="Update"
                                        Visible="false" />
                                    <asp:ImageButton ID="CancelButton" CommandArgument='<%# Eval("RuleID") %>' CommandName="Cancel"
                                        runat="server" ImageUrl="~/images/GVCancelButton.gif" AlternateText="Cancel"
                                        Visible="false" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="IP Mask" ItemStyle-Wrap="false">
                                ...
                                <EditItemTemplate>
                                    <asp:TextBox ID="IPAddrMaskTextBox" runat="server" Text='<%# Eval("IPAddrMask") %>'
                                        Width="150" />
                                </EditItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:BoundField DataField="Time" HeaderText="Created" DataFormatString="{0:dd-MMM-yyyy}"
                                ReadOnly="true" />
  ...
  --%>
                    ...
                    <div id="AddRule" style="display: none">
                        <div id="IP" style="visibility: hidden">
                            <div class="Label">
                                IP Mask:</div>
                            <div class="Input">
                                <asp:TextBox ID="IPTextBox" runat="server" Width="200" /></div>
                        </div>
                        <div id="URL" style="visibility: hidden">
                            <div class="Label">
                                URL Mask:</div>
                            <div class="Input">
                                <asp:TextBox ID="URLTextBox" runat="server" Width="200" /></div>
                        </div>
                        <div id="EZProxy" style="visibility: hidden">
                            <div class="Label">
                                URL Mask:</div>
                            <div class="Input">
                                <asp:TextBox ID="EZProxyTextBox" runat="server" Width="200" Enabled="false" Text="ezproxy://" /></div>
                        </div>
                        <div id="Notes" style="visibility: hidden">
                            <div class="Label">
                                Notes:</div>
                            <div class="Input">
                                <asp:TextBox ID="NotesTextBox" runat="server" TextMode="multiLine" Width="150" Height="40" /></div>
                        </div>
                        <div id="Priority" style="visibility: hidden">
                            <div class="Label">
                                Priority:</div>
                            <div class="Input">
                                <asp:TextBox ID="PriorityTextBox" runat="server" Width="20" /></div>
                        </div>
                        <div id="Disallow" style="visibility: hidden">
                            <div class="InputCheckbox">
                                <asp:CheckBox ID="DisallowCheckBox" runat="server" /></div>
                ...
                <asp:Panel ID="AddDomainPanel" runat="server" CssClass="b24-report-frame" Visible="false">
                    <p class="b24-doc-subtitle">
                        Add an Email Domain</p>
                    <p class="b24-helptext">
                        Allow users from the specified domain to register into this account. Enter the at
                        sign followed by the full domain (e.g., @skillsoft.com)</p>
                    <div class="Label">
                        <asp:Label ID="EmailDomainLabel" runat="server" Text="New Domain" CssClass="b24-forminputlabel"></asp:Label></div>
                    <div class="Input">
                        <asp:TextBox runat="server" ID="EmailDomainTextBox" CssClass="b24-forminput" MaxLength="96"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="EmailDomainValidator" ControlToValidate="EmailDomainTextBox"
                            CssClass="b24-forminputlabel" Display="Dynamic" ErrorMessage="Invalid Domain Name. 
        domains must be in the form @domain.com" runat="server" ValidationExpression="^@[\w.']*\.\w{2,3}$"></asp:RegularExpressionValidator></div>
                    <asp:CheckBox ID="CB_Email" runat="server" /><span class="b24-helptext">Users can register
                        with any/all email domains</span>
                </asp:Panel>
                <asp:Panel ID="RemoveDomainPanel" runat="server" CssClass="b24-report-frame" Visible="false">
                    <p class="b24-doc-subtitle">
                        Remove an Existing Email Domain</p>
                    <p class="b24-helptext">
                        Select domain(s) to remove.</p>
                    <div>
                        <asp:CheckBoxList runat="server" ID="EmailDomainCollection" RepeatDirection="Vertical">
                        </asp:CheckBoxList>
                    </div>
                </asp:Panel>
                <div id="UpdateEmailDomainDiv" runat="server" class="b24-report-frame" visible="false">
                    <asp:Button Text="Update" ID="UpdateEmailDomain" runat="server" OnClick="SubmitClick_UpdateDomain" /></div>
                <asp:Panel ID="SharedSecretPanel" runat="server" CssClass="b24-report-frame" Visible="false">
                    <hr />
                    <p class="b24-doc-subtitle">
                        Shared Secret</p>
                    <p class="b24-helptext">
                        Add a shared secret for use with tokens and EZProxy. Click on the Generate button
                        and the system will generate and save a new shared secret. Or manually enter a shared
                        secret and click Save.</p>
                    <div>
                        <asp:Label ID="Label1" runat="server" CssClass="b24-forminputlabel" Text="Existing Shared Secret: "></asp:Label><asp:Label
                            ID="SharedSecretCode" CssClass="b24-forminputlabel" runat="server"></asp:Label></div>
                    <br />
                    <div>
                        ...
                        <asp:UpdatePanel ID="SharedSecretUpdatePanel" runat="server">
                            <ContentTemplate>
                                <table>
                                    <tr>
                                        <td>
                                            <asp:Button runat="server" ID="Button_GenerateSharedSecretCode" Text="Generate new shared secret"
                                                OnClick="SubmitClick_NewSharedSecretCode" Width="200" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:TextBox runat="server" CssClass="b24-forminput" ID="NewSharedSecretCode" MaxLength="64"></asp:TextBox><asp:Button
                                                Text="Save" ID="SubmitSharedSecret" runat="server" OnClick="SubmitClick_SharedSecret" />
                                        </td>
                                    </tr>
                                </table>
                            </ContentTemplate>
